namespace easyInputs
{
    ...
    {
        /// <summary>
        /// Used for primary button up.
        /// </summary>
        private static Dictionary<EasyHand, bool> previousPrimaryButtonState = new Dictionary<EasyHand, bool>
        {
            { EasyHand.LeftHand, false },
            { EasyHand.RightHand, false }
        };
        ...
        /// <summary>
        /// Get's If The Primary Button Is Up.
        /// </summary>
        public static bool GetPrimaryButtonUp(EasyHand easyHand)
        {
            bool currentButtonDown = GetPrimaryButtonDown(easyHand);
            bool buttonUp = previousPrimaryButtonState[easyHand] && !currentButtonDown;
            previousPrimaryButtonState[easyHand] = currentButtonDown;
            return buttonUp;
        }
        ...
        {
            InputFeatureUsage<bool> indexTouch = new InputFeatureUsage<bool>("IndexTouch");
            GetInputBool(easyHand, indexTouch, out bool ButtonDown);
            return ButtonDown;
        }
        ...
        {
            GetInputVector3(easyHand, CommonUsages.primary2DAxis, out Vector2 ButtonDown);
            return ButtonDown;
        }
        ...
        static Vector2 GetInputVector3(EasyHand hand, InputFeatureUsage<Vector2> usage, out Vector2 value)
        {
            if (hand == EasyHand.LeftHand)
            {
                InputDevices.GetDeviceAtXRNode(XRNode.LeftHand).TryGetFeatureValue(usage, out value);
