...
namespace Liv.Lck.Settings
{
    public class LckSettings : ScriptableObject
    {
        ...
        [Header("Advanced")]
        [SerializeField]
        [Tooltip("Ask the user to confirm microphone access permission on app startup.")]
        public bool AskForMicPermissionOnAppStartup = true;
        [SerializeField]
