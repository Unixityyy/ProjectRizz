...
namespace Liv.Lck
{
    ...
    public class LckService : ILckService
    {
            ...
            ILckTelemetryClient telemetryClient)
        {
            ...
            _eventBridge.Forward<RecordingStartedEvent, LckResult>(r => OnRecordingStarted?.Invoke(r));
            ...
            _eventBridge.Forward<StreamingStartedEvent, LckResult>(r => OnStreamingStarted?.Invoke(r));
            ...
            // Monitor for errors in event results and send telemetry.
            _errorEventTelemetryBridge = new LckErrorEventTelemetryBridge(_eventBus, telemetryClient.SendErrorTelemetry);
            _errorEventTelemetryBridge.Monitor<RecordingStartedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<RecordingPausedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<RecordingResumedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<RecordingStoppedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<StreamingStartedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<StreamingStoppedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<PhotoCaptureSavedEvent, LckResult>();
            _errorEventTelemetryBridge.Monitor<LowStorageSpaceDetectedEvent, LckResult>();
        ...
        public LckResult StartStreaming()
        {
            ...
            if (_streamer is null or NullLckStreamer)
            {
