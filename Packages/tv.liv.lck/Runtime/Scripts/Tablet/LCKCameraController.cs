...
namespace Liv.Lck.Tablet
{
    ...
    public class LCKCameraController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // Attempt to enable the microphone by default.
        ...
        /// <summary>
        /// LateUpdate is used for camera movement to ensure it happens after all other game logic and physics
        /// for the frame (like player movement) have been completed. This prevents jitter.
        /// </summary>
        ...
        {
            if (_lckService == null) return;
            _lckService.SetMicrophoneCaptureActive(isMicOn);
        }
